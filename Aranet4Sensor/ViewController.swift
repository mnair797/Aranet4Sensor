...
class Aranet4ViewController: UIViewController {
...
extension Aranet4ViewController: CBCentralManagerDelegate {
...
extension Aranet4ViewController: CBPeripheralDelegate {
